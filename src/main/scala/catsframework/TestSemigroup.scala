...
- (a x b) x c == a x (b x c) == (b x c) x a
   ...
   The cats library semigroup implementation comes with a function “combine” which simply combines 2 values
   of the same data type(Int, List , string, Option, Map).
